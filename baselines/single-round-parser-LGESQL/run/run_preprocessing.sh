...
python3 -u preprocess/process_dataset.py --dataset_path ${test_data} --table_path ${table_out} --output_path 'data/test.bin'
...
python3 -u preprocess/process_graphs.py --dataset_path 'data/test.bin' --table_path ${table_out} --method 'lgesql' --output_path ${test_out}
