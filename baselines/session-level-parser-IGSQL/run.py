...
from run.parse_args import interpret_args
...
from run.model_util import Metrics, evaluate_utterance_sample, evaluate_interaction_sample, \
...
def main():
    ...
    params = interpret_args()   # 这里是命令行的超参数的加载

    # Prepare the dataset into the proper form.
    data = atis_data.ATISDataset(params)    # dataset的载入
