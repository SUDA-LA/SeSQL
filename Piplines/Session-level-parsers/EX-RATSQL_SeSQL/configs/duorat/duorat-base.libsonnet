function(output_from, data_path='data/SeSQL_follow_dependency_data/', save_dir='logdir/duorat_SeSQL/') {
    local PREFIX = data_path,
     data:{
         train:PREFIX+"train.json",
         dev:PREFIX+"dev.json",
         test:PREFIX+"test.json",
         db_content_path:PREFIX+"db_content.json",
         db_schema_path:PREFIX+"db_schema.json",
     },
#    data: {
