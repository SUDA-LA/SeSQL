...
config = json.loads(_jsonnet.evaluate_file("configs/duorat/duorat-finetune-bert-large-eval.jsonnet"))
data_path_dic = {"db_path":config["data"]["db_content_path"],"name":"spider","paths":config["data"]["test"],"tables_paths":config["data"]["db_schema_path"]}
data = registry.construct("dataset", data_path_dic)
with open('./logdir/duorat-sesql-bert-base-follow-dependency-expand-max-length-add-max-step-200000-seed-999/test-output-180000.eval.json', 'r') as f:
    eval = json.load(f)
...
with open('.//logdir/duorat-sesql-bert-base-follow-dependency-expand-max-length-add-max-step-200000-seed-999/SeSQL_test_predict.json', 'w') as f:
...
f = open('./logdir/duorat-sesql-bert-base-follow-dependency-expand-max-length-add-max-step-200000-seed-999/eval_SeSQL_test.txt', 'w')
