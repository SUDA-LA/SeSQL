...
def write_and_evaluate(postprocess_sqls, db_path, table_schema_path, gold_path, dataset):
  ...
  if dataset == 'spider':
    ...
    # import time
    # time.sleep(15)
    print('python eval_scripts/evaluation_sqa.py --db {} --table {} --etype match --gold {} --pred {}'.format(db_path,
                                                                                                      table_schema_path,
                                                                                                      gold_path,
                                                                                                      os.path.abspath(output_file)))
...
if __name__ == '__main__':
  ...
  parser.add_argument('--pred_file', type=str, default='logs_chase_editsql/valid-eval_predictions.json')
