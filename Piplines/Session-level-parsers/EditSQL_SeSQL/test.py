...
with open('./data/chase/dev_gold.txt', 'r', encoding="utf-8") as f:
    glist = []
    gseq_one = []
...
with open('./logs_chase_editsql/valid_use_predicted_queries_predictions.json.eval', 'r', encoding="utf-8") as f:
    res = f.readlines()
...
with open('./editsql_chase.json', 'w', encoding="utf-8") as f:
